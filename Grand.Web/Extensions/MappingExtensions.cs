        ...
        public static Address ToEntity(this AddressModel model, Address destination, bool trimFields = true)
        {
            ...
            if (trimFields)
            {
                ...
                if (model.IdentityNumber != null)
                    model.VatNumber = model.IdentityNumber.Trim();
            }
            ...
            destination.VatNumber = !String.IsNullOrEmpty(model.VatNumber) ? model.VatNumber : (model.IdentityNumber ?? model.IdentityNumber);
